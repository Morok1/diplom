...
import testheroku.example3.HashCodeValidator;
...
public class Main2 {
    ...
    public static void main(String[] args) throws MalformedURLException, ClassNotFoundException {
        List<Class> classes = getClassesList("/Users/evgenij/Documents/Проекты/Мои/projects/diplom/testJar/target/testJar-1.0-SNAPSHOT.jar");
